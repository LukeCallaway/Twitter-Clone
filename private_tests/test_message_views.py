...
class MessageViewTestCase(TestCase):
    ...
    def test_invalid_message_show(self):
        with self.client as c:
            ...
            resp = c.get('/messages/99999999', follow_redirects=True)

            # should redirect to the error page if message doesn't exist
            self.assertEqual(resp.status_code, 200)
            self.assertIn('Oops!', str(resp.data))
            self.assertIn("Looks like the page does not exist", str(resp.data))
